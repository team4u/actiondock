---
name: actiondock-cli
description: 使用 ActionDock CLI 完成脚本的作者态闭环、已发布脚本执行、Webhook 配置、插件查看与调用，以及围绕脚本源码中的 plugins.invoke(...) / scripts.invoke(...) 提供参考。适用于创建、调试、发布脚本，以及查找、运行、管理 Webhook、插件、定时任务和共享状态等日常使用场景。
---
