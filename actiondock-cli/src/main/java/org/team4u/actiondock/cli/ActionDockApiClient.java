...
/**
 * ActionDock REST API 客户端，封装与 ActionDock 服务端的 HTTP 通信。
 *
 * @author jay.wu
 */
public final class ActionDockApiClient {
    private final CliOutput output;
    private final ObjectMapper objectMapper;
    private final RestClient restClient;

    public ActionDockApiClient(CliConfigService.ResolvedConnectionConfig config, ObjectMapper objectMapper, CliOutput output) {
        this.output = output;
