...
/**
 * MCP {@code CallToolResult} content payload for a JSON text block.
 */
...
/**
 * MCP {@code CallToolResult} content payload marking the result as an error.
 */
 ...
 */
export function toMcpJson(data: unknown, policy: McpPolicy): McpTextResult {
 ...
 */
export function toMcpError(error: unknown): McpErrorResult {
