 ...
 */
export async function registerDynamicScriptTools(server, ctx) {
    ...
    for (const script of scripts) {
        try {
            ...
            console.error(`[actiondock-mcp] failed to register dynamic tool for script '${script.id}': ${describeError(error)}`);
        }
    }
}
/**
 ...
 */
function registerSingleDynamicScript(server, script, ctx) {
 ...
 */
function scriptInputShape(script) {
 ...
 * <description>]}.
 */
export function dynamicDescription(script) {
 ...
 */
export function extractInput(args) {
