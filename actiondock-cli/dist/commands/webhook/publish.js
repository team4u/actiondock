...
function parseScriptDependencies(value) {
...
function parseConfigItems(value) {
    if (!Array.isArray(value)) {
        return [];
    }
    return value.map((item) => {
    ...
    async run() {
        ...
        try {
            const payload = {
                ...
                scriptDependencies: parseScriptDependencies(parseJsonValueInput(flags["script-dependencies-json"], flags["script-dependencies-file"], {
                    jsonFlag: "`--script-dependencies-json`",
                    fileFlag: "`--script-dependencies-file`"
                })),
                configItems: parseConfigItems(parseJsonValueInput(flags["config-items-json"], flags["config-items-file"], {
