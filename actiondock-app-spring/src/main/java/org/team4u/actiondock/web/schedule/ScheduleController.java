...
public class ScheduleController {
    ...
    @GetMapping
    public ApiResponse<List<ScriptScheduleView>> list(@RequestParam(required = false) String intent) {
        return ApiResponse.success(IntentFilter.filter(support.listAll(), intent,
