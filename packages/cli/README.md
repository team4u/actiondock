...
[![Node.js](https://img.shields.io/badge/Node.js-%3E%3D22.13.0-green?logo=node.js)](https://nodejs.org/)
...
所有 CLI 子命令均支持前置或后置传入通用控制选项：

- `-v, -V, --version`：打印版本号并以状态码 0 退出。
- `-h, --help`：打印命令帮助并退出。
