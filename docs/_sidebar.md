...
- **使用者指南**
  ...
  - [接入开发工具 MCP 服务](/consumer/use-as-mcp.md)
  - [Node 交付产物与运行](/consumer/standalone-run.md)
...
- **底层架构**
  ...
  - [标准输出与错误通道隔离](/architecture/stdout-stderr.md)
