...
- **快速入门**
  - [系统概览与心智模型](/getting-started/overview.md)
  - [运行环境准备与安装](/getting-started/installation.md)
  - [快速上手指南](/getting-started/quick-start.md)

- **开发者指南**
  - [Action 核心模型与开发指南](/developer/first-action.md)
  - [Playbook 规程编写指南](/developer/playbooks.md)
...
- **场景实战**
  ...
  - [受控系统命令与子进程执行](/practices/process-execution.md)
  - [长时间异步任务与进度上报](/practices/long-running-tasks.md)
  - [多 Action 组合编排与防死锁](/practices/composing-actions.md)
  - [智能体协同开发与自愈闭环](/practices/ai-agent-development.md)

- **消费接入指南**
  - [消费与接入总览](/consumer/overview.md)
  - [Agent Skill 使用指南](/consumer/use-as-skill.md)
  - [开发工具 MCP 接入](/consumer/use-as-mcp.md)
  - [Node 交付产物运行](/consumer/standalone-run.md)
  - [HTTP 微服务与 API 调度](/consumer/http-service.md)
  - [配置注入与多环境管理](/consumer/configuration.md)
